...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // std::vector <DistMatrix<double,STAR,VC,ELEMENT,D>>
        // B_vector(numSubGrids);
        ...
        El::copy::TranslateBetweenGridsBroadcast<double, D, D>(A,
                                                               B_vector,
                                                               allreduceComm,
                                                               syncGeneral);
        ...
        for (Int i = 0; i < iters; ++i)
        {
            ...
            El::copy::TranslateBetweenGridsAllreduce<double, D, D>(A,
                                                                   B_vector,
                                                                   1);
        ...
        std::cout << "Rank:" << rank << " Total Time taken Allreduce(A<-B):"
        ...
        std::cout << "Rank:" << rank << " Total Time taken AllreduceOpt(A<-B):"
                  << duration_all / (iters - warmup) << endl;
        ...
        for (Int i = 0; i < iters; ++i)
        {
            ...
            El::copy::TranslateBetweenGridsAllreduce<double, D, D>(
                A,
                B_vector,
                allreduceComm,
                syncGeneral);
        ...
        double alpha = 1;
        std::cout << "Rank:" << rank
                  << " Total Time taken AllreduceOptComm(A<-B):"
                  << duration_all / (iters - warmup) << endl;
