...
// =============
template <typename T, Device D>
mpi::Comm const& BDM::DistComm() const EL_NO_EXCEPT { return this->Grid().VRComm(); }
...
template <typename T, Device D>
mpi::Comm const& BDM::ColComm() const EL_NO_EXCEPT { return this->Grid().MRComm(); }
template <typename T, Device D>
mpi::Comm const& BDM::RowComm() const EL_NO_EXCEPT { return this->Grid().MCComm(); }

template <typename T, Device D>
mpi::Comm const& BDM::PartialColComm() const EL_NO_EXCEPT { return this->ColComm(); }
template <typename T, Device D>
mpi::Comm const& BDM::PartialRowComm() const EL_NO_EXCEPT { return this->RowComm(); }
template <typename T, Device D>
