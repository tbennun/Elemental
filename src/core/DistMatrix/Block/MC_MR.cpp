...
// =============
template <typename T, Device D>
mpi::Comm const& BDM::DistComm() const EL_NO_EXCEPT { return this->Grid().VCComm(); }
...
template <typename T, Device D>
mpi::Comm const& BDM::ColComm() const EL_NO_EXCEPT { return this->Grid().MCComm(); }
template <typename T, Device D>
mpi::Comm const& BDM::RowComm() const EL_NO_EXCEPT { return this->Grid().MRComm(); }
